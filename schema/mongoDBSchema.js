...
const typeDefs = `
  ...
  type Query {
    ...
    getStudent_Q(_id:String,CODE:String,DESCR:String): [Student]
    getEnrollment_Q(_id:String,code:String,descr:String): [Enrollment]
    getFeeCode_Q(_id:String,code:String!,descr:String!): [FeeCode]
    getMarksCode_Q(_id:String,code:String!,descr:String!): [MarksCode]
  }
  type Mutation {
    addUser_M(name:String!,email:String!,password:String!,phone:String!,skey:String!): User
    updateUser_M(name:String!,email:String!,password:String!,phone:String!,skey:String!): UserPref
    ...
    setMarksCode_M(code:String,descr:String,mline:[MLine],gmarks:String): Code
    setMarksCodeDoc_M(_id:String,code:String,descr:String,mline:[MLine],gmarks:String): Code
    delMarksCodeDoc_M(_id:String): DelCode
    setFeeCode_M(code:String,descr:String,bfees:String,line:[Line],gamount:String): Code
    setFeeCodeDoc_M(_id:String,code:String,descr:String,bfees:String,line:[Line],gamount:String): Code
    delFeeCodeDoc_M(_id:String): DelCode
    setStudent_M(CODE: String,SKEY: String,DESCR: String,MIDDLE_NAME: String,LAST_NAME: String,DOB: String,FATHER_NAME: String,MOTHER_NAME: String,SPOUSE_NAME: String,SDOB: String,ADD_TYPE_1: String,ADD_LINE_1: String,ADD_LINE_2: String,PIN_CODE: String,STATE: String,COUNTRY: String,ADD_TYPE_2: String,ADD_LINE_12: String,ADD_LINE_22: String,PIN_CODE2: String,STATE2: String,COUNTRY2: String,MOBILE1: String,MOBILE2: String,EMAIL1: String,EMAIL2: String,DEGREE: String,COLLEGE: String,ADD_LINE_C1: String,ADD_LINE_C2: String,PIN_CODE_C: String,STATE_C: String,COUNTRY_C: String,REFERENCE_1: String,REFERENCE_1_ADD: String,REFERENCE_2: String,REFERENCE_2_ADD: String,JOB_CODE: String,SALARY_CODE: String,LEAVE_CODE: String): CODE
    setStudentDoc_M(_id:String,CODE: String,SKEY: String,DESCR: String,MIDDLE_NAME: String,LAST_NAME: String,DOB: String,FATHER_NAME: String,MOTHER_NAME: String,SPOUSE_NAME: String,SDOB: String,ADD_TYPE_1: String,ADD_LINE_1: String,ADD_LINE_2: String,PIN_CODE: String,STATE: String,COUNTRY: String,ADD_TYPE_2: String,ADD_LINE_12: String,ADD_LINE_22: String,PIN_CODE2: String,STATE2: String,COUNTRY2: String,MOBILE1: String,MOBILE2: String,EMAIL1: String,EMAIL2: String,DEGREE: String,COLLEGE: String,ADD_LINE_C1: String,ADD_LINE_C2: String,PIN_CODE_C: String,STATE_C: String,COUNTRY_C: String,REFERENCE_1: String,REFERENCE_1_ADD: String,REFERENCE_2: String,REFERENCE_2_ADD: String,JOB_CODE: String,SALARY_CODE: String,LEAVE_CODE: String): CODE
    delStudentDoc_M(_id:String): DelCode
    setEnrollment_M(code: String,descr: String,orgname: String,session: String,grade: String,comments: String): Enrollment
    setEnrollmentDoc_M(_id: String,code: String,descr: String,orgname: String,session: String,grade: String,comments: String): Enrollment
    delEnrollmentDoc_M(_id:String): DelCode
  }
`;
...
const resolvers = {
  Query: {
    ...
    getStudent_Q: (_, args, context) => getStudent_R(context, args, ["admin", "owner", "dummy"], getStudent_C),
    getEnrollment_Q: (_, args, context) => getEnrollment_R(context, args, ["admin", "owner", "dummy"], getEnrollment_C),
    getFeeCode_Q: (_, args, context) => getFeeCode_R(context, args, ["admin", "owner", "dummy"], getFeeCode_C),
    getMarksCode_Q: (_, args, context) => getMarksCode_R(context, args, ["admin", "owner", "dummy"], getMarksCode_C),
  },
  Mutation: {
    ...
    setStudent_M: (_, args, context) => setStudent_R(context, args, ["admin", "owner", "dummy"], setStudent_C),
    setStudentDoc_M: (_, args, context) => setStudentDoc_R(context, args, ["admin", "owner", "dummy"], setStudentDoc_C),
    delStudentDoc_M: (_, args, context) => delStudentDoc_R(context, args, ["admin", "owner", "dummy"], delStudentDoc_C),
    setEnrollment_M: (_, args, context) => setEnrollment_R(context, args, ["admin", "owner", "dummy"], setEnrollment_C),
    setEnrollmentDoc_M: (_, args, context) => setEnrollmentDoc_R(context, args, ["admin", "owner", "dummy"], setEnrollmentDoc_C),
    delEnrollmentDoc_M: (_, args, context) => delEnrollmentDoc_R(context, args, ["admin", "owner", "dummy"], delEnrollmentDoc_C),
    setFeeCode_M: (_, args, context) => setFeeCode_R(context, args, ["admin", "owner", "dummy"], setFeeCode_C),
    setFeeCodeDoc_M: (_, args, context) => setFeeCodeDoc_R(context, args, ["admin", "owner", "dummy"], setFeeCodeDoc_C),
    delFeeCodeDoc_M: (_, args, context) => delFeeCodeDoc_R(context, args, ["admin", "owner", "dummy"], delFeeCodeDoc_C),
    setMarksCode_M: (_, args, context) => setMarksCode_R(context, args, ["admin", "owner", "dummy"], setMarksCode_C),
    setMarksCodeDoc_M: (_, args, context) => setMarksCodeDoc_R(context, args, ["admin", "owner", "dummy"], setMarksCodeDoc_C),
    delMarksCodeDoc_M: (_, args, context) => delMarksCodeDoc_R(context, args, ["admin", "owner", "dummy"], delMarksCodeDoc_C),
  }
};
